...
import {
  Pair,
  Token,
  BlackbullFactory as BlackbullFactory,
  Transaction,
  Mint as MintEvent,
  Burn as BurnEvent,
  Swap as SwapEvent,
...
import { updatePairDayData, updateTokenDayData, updateBlackbullDayData as updateBlackbullDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  //let factory = BlackbullFactory.load(FACTORY_ADDRESS) // Is this needed?
